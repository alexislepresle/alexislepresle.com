              ...
              <main className="mx-auto px-4 sm:mt-12 sm:px-6 lg:px-8 flex flex-wrap items-center justify-center">
                <div className="text-center">
                  ...
                  <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-6xl">
                    ...
                    <span className="text-indigo-600 flex items-center justify-center tracking-wide	">Certifié Expert Shopify
                      <svg xmlns="http://www.w3.org/2000/svg" className="mx-2" width="50" height="50" viewBox="0 0 66 66" fill="none">
