            ...
            <div className="text-white py-24 max-w-5xl m-auto px-4 sm:px-6 lg:px-8 z-50	relative">
                ...
                <div className="grid grid-cols-4 md:grid-cols-6 gap-4">
                    <div className="md:col-start-2 col-start-0 col-span-4">
                        <div className="grid grid-cols-6 sm:h-64 md:h-40 h-80">
                ...
                <div className="flex justify-center mt-10">
                    {
                        data.map((testimonial, i) => {
                            return (
                                <div
                                    className={(i === currentTestimonial ? "px-6 rounded-full shadow-xl bg-gray-light " : " ") + "  px-5 py-2 cursor-pointer"}
                                ...
                                >
                                    ...
                                    <p className="font-light font-gray-400 text-sm">{testimonial.role}</p>
                                </div>
                            )
                        })
                    }
