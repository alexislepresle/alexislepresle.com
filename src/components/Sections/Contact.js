...
const Contact = () => {
    return (
        <div className="bg-gray-50">
            <div className="max-w-5xl mx-auto py-24 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                    <span className="block text-black">Travaillons ensemble !</span>
