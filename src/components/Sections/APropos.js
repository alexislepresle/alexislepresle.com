                ...
                <div className="mt-10">
                    <div className="space-y-10 md:space-y-0 flex items-center flex-wrap">
                        ...
                        <div className="lg:flex-1 mt-2 md:ml-16">
                            ...
                            <p className="mt-4 text-lg text-gray-700 flex flex-wrap mr-2">
                                De plus, j'ai la certification
                                <a className="underline text-indigo-600" href="https://experts.shopify.com/alexis-lepresle" rel="noreferrer" target="_blank">
