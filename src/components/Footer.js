        ...
        <footer className="py-12 text-gray-600 bg-white xl:pb-24">
            <div className="flex flex-col items-center justify-between max-w-screen-xl px-6 mx-auto mt-8 space-y-4 lg:px-8 xl:px-4 md:flex-row lg:mt-12">
                <nav className="flex flex-wrap justify-center space-x-6">
                    ...
                    <a href="https://experts.shopify.com/alexis-lepresle" target="_blank" className="mb-2 text-sm hover:text-indigo-600">Expert Shopify</a>
                </nav>
                <nav className="flex items-center space-x-2">
                    <a href="https://www.linkedin.com/in/alexislepresle/" className="text-gray-500 hover:text-indigo-600" target="_blank">
                    ...
                    <a href="https://www.instagram.com/alexislepresle/" className="text-gray-500 hover:text-indigo-600" target="_blank">
                    ...
                    <a href="https://twitter.com/alexislepresle" className="text-gray-500 hover:text-indigo-600" target="_blank">
