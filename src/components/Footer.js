        ...
        <footer className="py-12 text-gray-600 bg-white xl:pb-24">
            <div className="flex flex-col items-center justify-between max-w-screen-xl px-6 mx-auto mt-8 space-y-4 lg:px-8 xl:px-4 md:flex-row lg:mt-12">
                <nav className="flex flex-wrap justify-center space-x-6">
                    <a href="/#" className="mb-2 text-sm hover:text-gray-700">Mentions légales</a>
                    <a href="/#" className="mb-2 text-sm hover:text-gray-700">Blog</a>
                    <a href="/#" className="mb-2 text-sm hover:text-gray-700">Contact</a>
                    <a href="/#" className="mb-2 text-sm hover:text-gray-700">Expert Shopify</a>
                </nav>
